...
* Fixed **terrain holes** and **blocked paths** caused by
  `patch-ZZ95.MPQ`
...
* Added **UIMask.png** in the **reshade-shaders** folder to prevent MXAO from rendering over the UI.
...
* Improved **ReShade config** naming and paths.
* Added **Pixel Perfect Scaling** and **Google Drive bypass** guide.
...
* Initial release of the **Bronzebeard Ultra-HD Mod Pack**.
